...
+function ($) {
  ...
  Validator.prototype.showErrors = function ($el) {
    ...
    this.defer($el, function () {
      ...
      var $rttt = $group.find('.registration__form-input-error')
      var $whhh = $group.find('.registration__form-input-success')
      ...
      $rttt.css({'display':'block'})
      $whhh.css({'display':'none'})
    })
  }
  ...
  Validator.prototype.clearErrors = function ($el) {
    ...
    $whhh.css({'display':'block'})
    $rttt.css({'display':'none'})
  }
  ...
  Validator.prototype.destroy = function () {
    ...
    this.$element.find('.has-error').addClass('has-success')
